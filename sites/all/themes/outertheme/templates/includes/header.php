                    ...
                    <nav class="navbar navbar-expand-sm bg-dark# navbar-dark#">
                        ...
                        <div class="collapse navbar-collapse" id="collapsibleNavbar">
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= $base_root.$base_path.'about-us'?>">About Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= $base_root.$base_path.'faq'?>">FAQ</a>
                                </li> 
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= $base_root.$base_path.'contact-us'?>">Contact Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= $base_root.$base_path.'notice'?>">Notice</a>
                                </li>
                                <!-- <li class="nav-item">
